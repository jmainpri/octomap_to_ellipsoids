...
#ifndef GMR_CPP_CODE_
#define GMR_CPP_CODE_
...
class GaussianMixture
{
 ...
 /* Spline fitting to rescale trajectories. */
  ...
  /* init the GaussianMixture by performing k means on the data set */

  void initEM_3DBox(int nState, Matrix& DataSet, BBox box);
  /* init the GaussianMixture by means in a 3D bounding box (the data set has to be a point cloud).
  ...
  int doEM(Matrix DataSet, int max_iter);
